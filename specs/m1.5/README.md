...
| 10 | relay 部署脚本加固（为切换 `relay-khatru` fork 做准备） | [`tasks/10-relay-deploy-hardening.md`](tasks/10-relay-deploy-hardening.md) | — | S | done ([#23](https://github.com/iDoris-ai/agent-speaker/pull/23)) |
